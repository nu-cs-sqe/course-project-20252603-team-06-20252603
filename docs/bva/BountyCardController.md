...
- **TC1: one other player with 0 cards**
...
- **TC2: one other player with 1 card**
...
- **TC3: one other player with many cards**
...
- **TC4: multiple other players all with 0 cards**
...
- **TC5: multiple other players, some with 0 cards and some with 1 card**
...
- **TC6: multiple other players all with cards**
...
- **TC7: multiple other players, one with exactly 1 card and one with many**
