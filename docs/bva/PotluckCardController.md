...
- TC4: Exactly Two Players Remaining
  - **State of the system**: current player plays DRAW_FROM_BOTTOM, player 2 plays CAT_CARD_4
...
- TC1: All Players Have At Least One Card 
...
- TC2: Active Player Has No Cards 
