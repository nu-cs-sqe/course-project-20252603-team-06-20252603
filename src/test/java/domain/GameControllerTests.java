...
public class GameControllerTests {
    ...
    @Test
    void getControllerType_Attack() {
        Game game = new Game(2);
        GameController controller = new GameController(game);

        Card card = new Card(CardType.ATTACK);

        CardController expected = new AttackCardController();
    ...
    @Test
    void getControllerType_Nope() {
        Game game = new Game(2);
        GameController controller = new GameController(game);

        Card card = new Card(CardType.NOPE);

        CardController expected = new NopeCardController();
    ...
    @Test
    void getControllerType_CatCardTwo() {
        Game game = new Game(2);
        GameController controller = new GameController(game);

        Card card = new Card(CardType.CAT_CARD_2);
    ...
    @Test
    void getControllerType_CatCardThree() {
        Game game = new Game(2);
        GameController controller = new GameController(game);

        Card card = new Card(CardType.CAT_CARD_3);
    ...
    @Test
    void getControllerType_CatCardFour() {
        Game game = new Game(2);
        GameController controller = new GameController(game);

        Card card = new Card(CardType.CAT_CARD_4);
